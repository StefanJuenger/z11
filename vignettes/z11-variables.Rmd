...
kbl(datensatzbeschr, col.names = c("Beschreibung", "Variablenname")) %>%
  kable_styling(full_width = TRUE) %>%
  pack_rows(index = c("Spitze Werte" = 10, "Klassierte Werte" = 10),
...
filenames <- list.files(path = "/home/sarah/Daten/R/Zensus11/data/100m")
...
kableExtra::kbl(df[2:4], format = "html", col.names = c("Beschreibung", "Ausprägung", "Variablenname")) %>%
  pack_rows(index = kat, label_row_css = "background-color: #888; color: #fff;") %>%
